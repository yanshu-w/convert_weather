...
(
    ...
    humidity                        decimal(5, 2) comment '地表 2 米湿度相对湿度(%)',
    cloudrate                       decimal(5, 2) comment '总云量(0.0-1.0)',
    skycon                          varchar(200) comment '天气现象',
    visibility                      decimal(5, 2) comment '地表水平能见度',
    dswrf                           decimal(5, 2) comment '向下短波辐射通量(w/m2)',
    wind_speed                      decimal(5, 2) comment '地表 10 米风速',
    wind_direction                  decimal(5, 2) comment '地表 10 米风向',
    pressure                        decimal(5, 2) comment '地面气压',
    ...
    air_quality_co                  decimal(5, 2) comment '一氧化碳浓度（mg/m3）',
...
(
    ...
    precipitation_value           decimal(5, 2) comment '降水量',
    precipitation_probability     decimal(5, 2) comment '降水概率',
    temperature_datetime          datetime comment '气温时间',
    temperature_value             decimal(5, 2) comment '地表2米气温',
    apparent_temperature_datetime datetime comment '体感温度时间',
    apparent_temperature_value    decimal(5, 2) comment '体感温度',
    ...
    humidity_value                decimal(5, 2) comment '相对湿度',
    cloudrate_datetime            datetime comment '云量时间',
    cloudrate_value               decimal(5, 2) comment '云量',
    ...
    visibility_value              decimal(5, 2) comment '水平能见度',
    ...
    air_quality_pm25              decimal(5, 2) comment 'pm2.5浓度',
    forecast_time                 datetime comment '预报时间',
    create_time                   datetime comment '创建时间'
) comment '小时级天气信息表';
...
(
    ...
    precipitation_08h_20h_max         decimal(5, 2) comment '白天最大降水量',
    precipitation_08h_20h_min         decimal(5, 2) comment '白天最小降水量',
    precipitation_08h_20h_avg         decimal(5, 2) comment '白天平均降水量',
    precipitation_08h_20h_probability decimal(5, 2) comment '白天降水概率',
    precipitation_20h_32h_date        datetime comment '夜晚降水日期',
    precipitation_20h_32h_max         decimal(5, 2) comment '夜晚最大降水量',
    precipitation_20h_32h_min         decimal(5, 2) comment '夜晚最小降水量',
    precipitation_20h_32h_avg         decimal(5, 2) comment '夜晚平均降水量',
    precipitation_20h_32h_probability decimal(5, 2) comment '夜晚降水概率',
    precipitation_date                datetime comment '全天降水日期',
    precipitation_max                 decimal(5, 2) comment '全天最大降水量',
    precipitation_min                 decimal(5, 2) comment '全天最小降水量',
    precipitation_avg                 decimal(5, 2) comment '全天平均降水量',
    precipitation_probability         decimal(5, 2) comment '全天降水概率',
    temperature_date                  datetime comment '气温日期',
    temperature_max                   decimal(5, 2) comment '全天最高气温',
    temperature_min                   decimal(5, 2) comment '全天最低气温',
    temperature_avg                   decimal(5, 2) comment '全天平均气温',
    temperature_08h_20h_date          datetime comment '白天气温日期',
    temperature_08h_20h_max           decimal(5, 2) comment '白天最高气温',
    temperature_08h_20h_min           decimal(5, 2) comment '白天最低气温',
    temperature_08h_20h_avg           decimal(5, 2) comment '白天平均气温',
    temperature_20h_32h_date          datetime comment '夜晚气温日期',
    temperature_20h_32h_max           decimal(5, 2) comment '夜晚最高气温',
    temperature_20h_32h_min           decimal(5, 2) comment '夜晚最低气温',
    temperature_20h_32h_avg           decimal(5, 2) comment '夜晚平均气温',
    wind_date                         datetime comment '风速日期',
    wind_max_speed                    decimal(5, 2) comment '全天最大风速',
    wind_max_direction                decimal(5, 2) comment '全天最大风向',
    wind_min_speed                    decimal(5, 2) comment '全天最小风速',
    wind_min_direction                decimal(5, 2) comment '全天最小风向',
    wind_avg_speed                    decimal(5, 2) comment '全天平均风速',
    wind_avg_direction                decimal(5, 2) comment '全天平均风向',
    wind_08h_20h_date                 datetime comment '白天风速日期',
    wind_08h_20h_max_speed            decimal(5, 2) comment '白天最大风速',
    wind_08h_20h_max_direction        decimal(5, 2) comment '白天最大风向',
    wind_08h_20h_min_speed            decimal(5, 2) comment '白天最小风速',
    wind_08h_20h_min_direction        decimal(5, 2) comment '白天最小风向',
    wind_08h_20h_avg_speed            decimal(5, 2) comment '白天平均风速',
    wind_08h_20h_avg_direction        decimal(5, 2) comment '白天平均风向',
    wind_20h_32h_date                 datetime comment '夜晚风速日期',
    wind_20h_32h_max_speed            decimal(5, 2) comment '夜晚最大风速',
    wind_20h_32h_max_direction        decimal(5, 2) comment '夜晚最大风向',
    wind_20h_32h_min_speed            decimal(5, 2) comment '夜晚最小风速',
    wind_20h_32h_min_direction        decimal(5, 2) comment '夜晚最小风向',
    wind_20h_32h_avg_speed            decimal(5, 2) comment '夜晚平均风速',
    wind_20h_32h_avg_direction        decimal(5, 2) comment '夜晚平均风向',
    humidity_date                     datetime comment '湿度日期',
    humidity_max                      decimal(5, 2) comment '最大湿度',
    humidity_min                      decimal(5, 2) comment '最小湿度',
    humidity_avg                      decimal(5, 2) comment '平均湿度',
    cloudrate_date                    datetime comment '云量日期',
    cloudrate_max                     decimal(5, 2) comment '最大云量',
    cloudrate_min                     decimal(5, 2) comment '最小云量',
    cloudrate_avg                     decimal(5, 2) comment '平均云量',
    ...
    visibility_max                    decimal(5, 2) comment '最大能见度',
    visibility_min                    decimal(5, 2) comment '最小能见度',
    visibility_avg                    decimal(5, 2) comment '平均能见度',
    ...
    pm25_max                          decimal(5, 2) comment 'pm2.5 最大浓度',
    pm25_avg                          decimal(5, 2) comment 'pm2.5 平均浓度',
    pm25_min                          decimal(5, 2) comment 'pm2.5 最小浓度',
...
insert into ultraviolet_realtime_dict(level_desc)
values ('无'),
       ('很弱'),
       ('很弱'),
       ('弱'),
...
insert into dressing_dict(description)
values ('极热'),
       ('极热'),
       ('很热'),
       ('热'),
...
insert into comfort_dict(description)
values ('闷热'),
       ('酷热'),
       ('很热'),
       ('热'),
...
INSERT INTO wind_level_dict (min_speed, max_speed, min_intensity, max_intensity, level_description)
VALUES (0, 1, 0, 0.3, '无风'),
       (1, 5, 0.3, 1.6, '微风徐徐'),
       (6, 11, 1.6, 3.4, '清风'),
       (12, 19, 3.4, 5.5, '树叶摇摆'),
       (20, 28, 5.5, 8.0, '树枝摇动'),
       (29, 38, 8.0, 10.8, '风力强劲'),
       (39, 49, 10.8, 13.9, '风力强劲'),
       (50, 61, 13.9, 17.2, '风力超强'),
       (62, 74, 17.2, 20.8, '狂风大作'),
       (75, 88, 20.8, 24.5, '狂风呼啸'),
       (89, 102, 24.5, 28.5, '暴风毁树'),
       (103, 117, 28.5, 32.7, '暴风毁树'),
       (118, 133, 32.7, 37.0, '飓风'),
       (134, 149, 37.0, 41.5, '台风'),
       (150, 166, 41.5, 46.2, '强台风'),
       (167, 183, 46.2, 51.0, '强台风'),
       (184, 201, 51.0, 56.1, '超强台风'),
       (202, 220, 56.1, 61.3, '超强台风');
